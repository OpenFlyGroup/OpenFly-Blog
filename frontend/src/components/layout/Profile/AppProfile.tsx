            ...
            <div className="grid grid-cols-4 lg:grid-cols-12 gap-6">
                <div className="col-span-4 lg:col-span-3">
                    ...
                    className=" bg-secondary drop-shadow-2xl rounded-2xl p-6">
                        <div className="flex flex-col items-center">
                            ...
                            <h1 className="text-xl text-primary font-bold">John Doe</h1>
                        ...
                        <div className="flex flex-col">
                            ...
                            <ul>
                                <li className="mb-2 text-primary">JavaScript</li>
                                <li className="mb-2 text-primary">React</li>
                                <li className="mb-2 text-primary">Node.js</li>
                                <li className="mb-2 text-primary">HTML/CSS</li>
                                <li className="mb-2 text-primary">Tailwind Css</li>
                            </ul>
                        </div>
                    </motion.div>
                </div>
                <div className="col-span-4 lg:col-span-9">
                    ...
                    className=" bg-secondary drop-shadow-2xl rounded-2xl p-6">
                        ...
                        <p className="text-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed finibus est
                        ...
                        <div className="flex justify-center items-center gap-6 my-6">
                            <a className="text-white hover:text-primary" aria-label="Visit TrendyMinds LinkedIn" href=""
                                target="_blank">
                            ...
                            <a className="text-white hover:text-primary" aria-label="Visit TrendyMinds YouTube" href=""
                                target="_blank">
                            ...
                            <a className="text-white hover:text-primary" aria-label="Visit TrendyMinds Facebook" href=""
                                target="_blank">
                            ...
                            <a className="text-white hover:text-primary" aria-label="Visit TrendyMinds Instagram" href=""
                                target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="h-6">
                                    <path fill="currentColor"
                            ...
                            <a className="text-white hover:text-primary" aria-label="Visit TrendyMinds Twitter" href=""
                                target="_blank">
                        ...
                        <h2 className="text-primary text-xl font-bold mt-6 mb-4">Experience</h2>
                        <div className="mb-6">
