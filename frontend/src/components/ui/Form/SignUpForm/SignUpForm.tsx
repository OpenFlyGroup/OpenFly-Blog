                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        className="space-y-4 md:space-y-6">
                            <div>
                                ...
                                <input type="text" {...formRegister("nickname")} id="text" className="bg-gray-50 border border-gray-300 text-secondary sm:text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5" placeholder="nickname" required />
                            </div>
                            <div>
                                <FormLabel>Your email</FormLabel>
                                <input type="email" {...formRegister("email")} id="email" className="bg-gray-50 border border-gray-300 text-secondary sm:text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5" placeholder="name@company.com" required />
                            </div>
                            <div>
