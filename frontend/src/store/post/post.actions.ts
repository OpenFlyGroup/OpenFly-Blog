...
export const updateExistingPost = createAsyncThunk<IPost, { id: string | number; data: IPost }>(
...
export const leaveComment = createAsyncThunk<IPost, { id: string | number; commentText: string }>(
  'posts/leaveComment',
