                ...
                <div className="w-full bg-white rounded-2xl shadow md:mt-0 sm:max-w-md xl:p-0">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6">
                            ...
                            <button type="submit" className="w-full text-white bg-[#0000ff] hover:bg-[#0000ff] focus:ring-4 focus:outline-none focus:ring-[#0000ff] font-medium rounded-lg text-sm px-5 py-2.5 text-center">Sign up</button>
